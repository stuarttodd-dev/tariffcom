        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div v-if="user.photo" class="md:col-span-2">
              ...
              <div>
                ...
                <p class="mt-1 text-sm text-gray-900">{{ user.prefixname || 'N/A' }}</p>
              </div>

              <div>
                <label class="block text-sm font-medium text-gray-700">Suffix</label>
                <p class="mt-1 text-sm text-gray-900">{{ user.suffixname || 'N/A' }}</p>
              </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
              ...
              <div v-if="user.details && user.details.length > 0" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div v-for="detail in user.details" :key="detail.id" class="bg-gray-50 p-4 rounded-lg">
